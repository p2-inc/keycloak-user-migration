...
public final class ConfigurationProperties {
    ...
    public static final String CASE_INSENSITIVE_USERNAME_PROPERTY = "CASE_INSENSITIVE_USERNAME";
    ...
    private static final List<ProviderConfigProperty> PROPERTIES = List.of(
            ...
            new ProviderConfigProperty(MIGRATE_UNMAPPED_GROUPS_PROPERTY,
                    ...
                    "Whether or not to migrate groups not found in the field above",
                                       BOOLEAN_TYPE, true),
            new ProviderConfigProperty(CASE_INSENSITIVE_USERNAME_PROPERTY,
                    "Ignore username case",
                    "Whether or not to ignore case when comparing local and remote usernames",
                    BOOLEAN_TYPE, false)
    );
